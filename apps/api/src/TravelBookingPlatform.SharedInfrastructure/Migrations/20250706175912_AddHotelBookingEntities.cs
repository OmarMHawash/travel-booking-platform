...
namespace OmarHawash.TravelBookingPlatform.Migrations
{
    ...
    public partial class AddHotelBookingEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Hotel_Name_Unique",
                table: "Hotel",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Hotel_Rating",
                table: "Hotel",
                column: "Rating");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Room_HotelId_RoomNumber_Unique",
                table: "Room",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomType_Capacity",
                table: "RoomType",
                columns: new[] { "MaxAdults", "MaxChildren" });

            migrationBuilder.CreateIndex(
                name: "IX_RoomType_Name_Unique",
                table: "RoomType",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RoomType_PricePerNight",
                table: "RoomType",
